# vrf_brief.py
# Refactored to save results to Excel files in a specified folder.

import os
import glob
import json
from typing import Dict, List, Set, Tuple
from collections import Counter  # (kept in case you want to reuse)
from pathlib import Path

import pandas as pd

# Where to write output files (Excel + JSON). Change to suit your environment.
...
# Switch groups (unchanged from your file)
switch_types = {
...
def compare_zone_vlans_tor_vs_cor(vlan_data, zone_vrf_data, zone_name):
    ...
    for dc in ["DC1", "DC2"]:
        ...
        # 3) COR baseline & COR comparisons
